...
(function() {
    ...
    function checkDomain() {
        ...
        const checdo = window.location.hostname;
        
        
        if (checdo !== aldomi) {
            if (window.location.href !== `https://${aldomi}`) {
                window.location.replace(`https://${aldomi}`);
            }
    ...
    function translateToEnglish(arabicText) {
        const translations = {
            'ل ؟': 'An amazing Minecraft modification that enhances your gaming experience with new features, improved graphics, and exciting gameplay elements. Download now to discover all the incredible features this mod has to offer!',
        };
